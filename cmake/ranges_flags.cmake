...
set(CMAKE_REQUIRED_FLAGS "${RANGES_STD_FLAG}")
check_cxx_source_compiles("${RANGE_V3_PROBE_CODE}" RANGE_V3_COROUTINE_PROBE)
if(NOT RANGE_V3_COROUTINE_PROBE)
  if(RANGES_CXX_COMPILER_MSVC)
    set(RANGE_V3_COROUTINE_FLAGS "/await")
  elseif(RANGES_CXX_COMPILER_CLANG)
    set(RANGE_V3_COROUTINE_FLAGS "-fcoroutines-ts")
  elseif(RANGES_CXX_COMPILER_GCC)
    set(RANGE_V3_COROUTINE_FLAGS "-fcoroutines")
  endif()
  set(CMAKE_REQUIRED_FLAGS ${RANGE_V3_COROUTINE_FLAGS} ${RANGES_STD_FLAG})
  check_cxx_source_compiles("${RANGE_V3_PROBE_CODE}" RANGE_V3_COROUTINE_FLAG_PROBE)
  if(RANGE_V3_COROUTINE_FLAG_PROBE)
    add_compile_options(${RANGE_V3_COROUTINE_FLAGS})
  else()
    unset(RANGE_V3_COROUTINE_FLAGS)
  endif()
endif()
unset(CMAKE_REQUIRED_FLAGS)
unset(RANGE_V3_PROBE_CODE)
...
set(CMAKE_REQUIRED_FLAGS "${RANGES_STD_FLAG}")
check_cxx_source_compiles("${RANGE_V3_PROBE_CODE}" RANGE_V3_CONCEPTS_PROBE)
if(NOT RANGE_V3_CONCEPTS_PROBE)
