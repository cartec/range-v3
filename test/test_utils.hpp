...
// In C++20, implicit capture of `this` by copy is deprecated.
#if RANGES_CXX_VER > RANGES_CXX_STD_17
#define CAPTURE_COPY_THIS =,this
#else
#define CAPTURE_COPY_THIS =
#endif
...
public:
    ...
    static checker<R> impl(I begin, I end, Eval1 e1, Eval2 e2)
    {
        ...
        return checker<R>{[CAPTURE_COPY_THIS](function_ref<void(R)> const & check)
        {
            check(e1(begin, end));
